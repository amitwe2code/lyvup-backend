...
class Activity(models.Model):
    ...
    completion_check = models.CharField(max_length=255,null=True, blank=True)
    ...
    upload_possible = models.CharField(max_length=255,default='',blank=True,null=True)
    ...
    send_reminder = models.CharField(max_length=255,default='', blank=True )
    show_in_task = models.CharField(max_length=255,default='',blank=True)
    add_comment_option = models.CharField(max_length=255,default='',blank=True)
    indicate_when_completed = models.CharField(max_length=255,default='',blank=True ,null=True)
